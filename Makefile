...
build:
	...
	. $(BASH_ROS_SOURCE) && . $(BASH_VRX_SOURCE) && colcon build --base-paths $(SRC_PATH) --merge-install
...
launch_real_mission:
	@echo "\e[32m[INFO] Launching Aquabot competition with the real world: $(COMPET_WORLD)...\e[0m"
